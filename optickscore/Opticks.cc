...
+----------------+--------------+--------------+-----------------+---------------------------------+  
| --sizescale    | resolution   | pixels       |  mega pixels    | notes                           | 
+================+==============+==============+=================+=================================+  
|     1.0        |   1280,720   |      921,600 |     0.92        | typical presentation resolution |
+----------------+--------------+--------------+-----------------+---------------------------------+  
|     1.5        |   1920,1080  |    2,073,600 |     2.07        | long used as default render size|
+----------------+--------------+--------------+-----------------+---------------------------------+  
|     2.0        |   2560,1440  |    3,686,400 |     3.68        |                                 |
+----------------+--------------+--------------+-----------------+---------------------------------+  
