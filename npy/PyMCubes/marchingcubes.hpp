...
extern int NPY_API edge_table[256];
extern int NPY_API triangle_table[256][16];
...
double mc_isovalue_interpolation(double isovalue, double f1, double f2,
    double x1, double x2);
void NPY_API mc_add_vertex(double x1, double y1, double z1, double c2,
...
template<typename coord_type, typename vector3, typename SDF>
void marching_cubes(const vector3& lower, const vector3& upper,
    int numx, int numy, int numz, SDF f, double isovalue,
