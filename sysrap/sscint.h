...
struct sscint
{
   ...
   static void FillGenstep( sscint& gs, int genstep_id, int numphoton_per_genstep, bool dump ) ;
...
inline void sscint::FillGenstep( sscint& gs, int genstep_id, int numphoton_per_genstep, bool dump )
{
